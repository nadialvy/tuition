        ...
        methods:{
            ...
            saveData(){
                ...
                if(this.action == 'Add'){
                    ...
                    this.axios.post('http://localhost:8000/api/grade', form, token)
                    .then( () => {
                        this.$swal({
                            title: 'Success' ,
                    ...
                    this.axios.put('http://localhost:8000/api/grade/' + this.grade_id, form, token)
                    .then( () => {
                        this.$swal({
                            title: 'Success' ,
            ...
            removeData(id){
                this.$swal({
                    ...
                    if(value.isConfirmed){
                        ...
                        this.axios.delete('http://localhost:8000/api/grade/' + id, token)
                        .then(resp => {
